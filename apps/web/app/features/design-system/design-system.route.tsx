...
export default function DesignSystemRoute() {
  ...
  return (
    <main className="grid min-h-screen grid-cols-[3.5rem_minmax(0,1fr)] bg-background text-foreground">
      ...
      <section
        aria-labelledby="design-system-app-title"
        className="flex min-h-screen min-w-0 flex-col gap-3.5 px-3 pt-4 pb-6 lg:px-6"
      >
        <AppHeader breadcrumbs={[{ label: "Design System" }]} headingId="design-system-app-title" />

        <div className="mx-auto grid w-full max-w-[1180px] gap-8 py-6">
          <header className="grid gap-4">
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl text-md text-muted-foreground">
                This page previews the local Tailwind v4 theme, shadcn-compatible component setup,
                and Stableflow-specific primitives used for live tables, flow maps, protocol
                surfaces, and inspection views.
              </p>
            </div>
          </header>
          ...
          <Panel>
            ...
            <PanelBody className="grid gap-3 text-muted-foreground text-sm md:grid-cols-3">
              <p>
                Use semantic tokens like bg-card, text-foreground, border-border, and ring-ring.
              </p>
